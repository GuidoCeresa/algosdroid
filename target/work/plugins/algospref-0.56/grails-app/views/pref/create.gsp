...
<html>
	...
	<body>
		<a href="#create-pref" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-pref" class="content scaffold-create" role="main">
            <h1><g:message code="pref.create.label" args="[entityName]" default="Nuovo"/></h1>
